...
- `入门层/从零开始认识CICD系列/` — 0 导读 + 6 篇：CI/CD 三段论、流水线设计、构建提速、测试门禁、制品管理、部署策略与回滚
- [CICD 进阶](./advanced/) — 复杂场景与优化（Matrix 矩阵、可复用工作流）
- [GitHub Actions](./github-actions/) — GitHub Actions 实战（总览 + 最小可用流水线）
