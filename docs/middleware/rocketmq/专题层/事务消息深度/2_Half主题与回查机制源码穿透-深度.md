...
## 9. 业内惯例：Half 主题的跨周期/跨业务形态/跨系统视角
...
本文涉及的 HalfTopic 设计、Op 消息状态机、回查机制源码均来自 RocketMQ 4.x / 5.x 官方文档与社区公开 issue。事故案例为社区公开经验总结，已脱敏处理。跨系统对比、跨业务形态 SOP 对比均为社区共识总结。
