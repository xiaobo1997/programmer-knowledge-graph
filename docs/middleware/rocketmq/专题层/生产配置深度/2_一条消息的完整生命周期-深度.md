...
## 3. 主流业界解法：3 类业务形态的 Group 命名 + 生命周期管控
...
| 业务形态 | Group 命名规范 | 灰度策略 | 故障隔离 |
|---|---|---|---|
| 保守型 | 业务_角色_V3_环境 | V1/V2/V3 灰度 | 业务域隔离 |
| 高吞吐型 | 业务_角色_HOT/COLD | 按流量优先级 | 多集群隔离 |
| 业务分级型 | 业务_角色_环境 | 机房 + 环境 | 业务域隔离 |
